...
```{r Describe_Selected_Petrinet_1, echo=TRUE, fig.height=5.0}
...
```{r Describe_Selected_Petrinet_2, echo=TRUE, fig.height=5.0}
source("~/Dropbox/datascience/R/mypetrinet.R")
replay_ILP_lst <- replay.petrisim(ILP_pn, "T00,T02,T05")
