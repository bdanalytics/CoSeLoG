...
petrinets_df <- data.frame("Petrinet"=c("Alpha"),
                           ...
                           "Simplicity.Total.Places"=c(9),
                           "Simplicity.Total.Places.Silent"=c(0),
                           "Simplicity.Total.Transitions.Silent"=c(0),
                           "Simplicity.Total.Arcs"=c(4+3+3+2+4+2+3+9),
                           "Simplicity.MDL"=c(1),
...
petrinets_df <- rbind(petrinets_df, 
                data.frame("Petrinet"=c("ILP"),
                           ...
                           "Simplicity.Total.Places"=c(8),
                           "Simplicity.Total.Places.Silent"=c(0),
                           "Simplicity.Total.Transitions.Silent"=c(0),
                           "Simplicity.Total.Arcs"=c(1+3+8+2+5+2),
                           "Simplicity.MDL"=c(3),
...
petrinets_df <- rbind(petrinets_df, 
                data.frame("Petrinet"=c("Heuristics"),
                           ...
                           "Simplicity.Total.Places"=c(18),
                           "Simplicity.Total.Places.Silent"=c(0),
                           "Simplicity.Total.Transitions.Silent"=c(14),
                           "Simplicity.Total.Arcs"=c(1+1+2+4+1+2+2+3+2+2+1+1+1+2+4+1+3+2+2+2+2+1+1+1),
                           "Simplicity.MDL"=c(2),
...
petrinets_df <- rbind(petrinets_df, 
                data.frame("Petrinet"=c("Inductive"),
                           ...
                           "Simplicity.Total.Places"=c(21),
                           "Simplicity.Total.Places.Silent"=c(0),
                           "Simplicity.Total.Transitions.Silent"=c(25),
                           "Simplicity.Total.Arcs"=c(1+4+6+6+4+3+5+9+9+4+3+4+3+3+3+1),
                           "Simplicity.MDL"=c(13),
