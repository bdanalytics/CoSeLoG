...
\CommentTok{#                       c("Simplicity.Places.Total", "Simplicity.Places.Total.Score")))}
...
\NormalTok{\}}
\NormalTok{petrinets_df <-}\StringTok{ }\KeywordTok{consolidate_scores}\NormalTok{(}\DataTypeTok{pn_df=}\NormalTok{petrinets_df, }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(petrinets_df)}
\end{Highlighting}
\end{Shaded}
