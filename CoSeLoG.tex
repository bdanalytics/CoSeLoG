...
##     Alpha         0.8987                       9                     1
##  Simplicity.Places.Implicit Simplicity.Transitions.Isolated
##                           0                               3
##  Simplicity.Transitions.Silent Simplicity.Arcs Simplicity.MDL
##                              0              30              1
...
\NormalTok{petrinets_mod_df <-}\StringTok{ }\KeywordTok{consolidate_scores}\NormalTok{(}\DataTypeTok{pn_df=}\NormalTok{petrinets_df, }
        ...
        \DataTypeTok{consolidated.metric.name=}\StringTok{"Simplicity.Score"}
...
## Heuristics                     0.7698               0.8656
## Inductive                      0.9813               0.9955
##            Simplicity.Places.Total.Scaled Simplicity.Places.Total.Weighted
## Alpha                            88.88889                        12.698413
## ILP                             100.00000                        14.285714
## Heuristics                       44.44444                         6.349206
## Inductive                        38.09524                         5.442177
##            Simplicity.Places.End.Scaled Simplicity.Places.End.Weighted
## Alpha                            100.00                     14.2857143
## ILP                               50.00                      7.1428571
## Heuristics                         6.25                      0.8928571
## Inductive                        100.00                     14.2857143
...
## Heuristics                            14.28571
## Inductive                             14.28571
##            Simplicity.Transitions.Isolated.Scaled
## Alpha                                          25
## ILP                                           100
## Heuristics                                    100
## Inductive                                     100
##            Simplicity.Transitions.Isolated.Weighted
## Alpha                                      3.571429
## ILP                                       14.285714
## Heuristics                                14.285714
## Inductive                                 14.285714
...
## Alpha                                  14.2857143               70.00000
## ILP                                    14.2857143              100.00000
## Heuristics                              0.9523810               47.72727
## Inductive                               0.5494505               30.88235
##            Simplicity.Arcs.Weighted Simplicity.MDL.Scaled
## Alpha                     10.000000            100.000000
## ILP                       14.285714             33.333333
## Heuristics                 6.818182             50.000000
## Inductive                  4.411765              7.692308
##            Simplicity.MDL.Weighted Simplicity.Score
## Alpha                    14.285714         83.41270
## ILP                       4.761905         83.33333
## Heuristics                7.142857         50.72691
## Inductive                 1.098901         54.35944
\end{verbatim}

In my opinion, the ILP discovered Petri net is the best based on the
following criteria:

`+' Integrate all event log transitions into the control-flow (ILP,
Heuristics \& Inductive).\\`+' No silent transitions (ILP \&
Alpha).\\`+' Less arcs (ILP \& Heuristics).
...
\item
  ...
  implicit places\\2.4 \# silent transitions\\2.5 \# arcs\\2.6 Entropy:
  ProM plug-in ?\\2.7 Minimal Description Length (MDL): ProM plug-in ?
\item
...
i.e.~25\% for each metric category and ???\% for the Simplicity metric
